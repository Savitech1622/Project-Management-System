...
const OrgCard = ({title = 'Project Batch 2025', count = 4}) => {
    return (
        <div style={{cursor:'pointer', boxShadow:'0 2px 12px rgba(0, 0, 0, 0.08)', width:'450px', display:'flex', marginBlock:'8px', gap:'12px', paddingInline:'12px', paddingBlock:'24px', border:'1px solid #00000036', borderRadius:'12px', alignItems:'center'}}>
